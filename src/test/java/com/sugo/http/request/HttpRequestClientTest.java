package com.sugo.http.request;

import com.sugo.domain.dto.RequestDTO;
import com.sugo.domain.dto.ResponseDTO;
import com.sugo.http.HttpRequestClient;
...
//        ResponseDTO responseDTO = httpRequestClient.executeGetWithParams(baseUrl, requestDTO);
    ...
    public void executePostWithRow() throws Exception {
        ...
        String json = "{\"telephone\": \"13803623955\",\"password\": \"cxl111111\",\"device\": \"pc\",\"platform\": \"sugo\",\"clientIP\": \"10.255.1.112\"}";
        RequestDTO requestDTO = new RequestDTO();
...
//        HttpRequestClient httpRequestClient = new HttpRequestClient();
//        String baseUrl = "http://a.io.tzj.net/";
//        String json = "{\"telephone\": \"13803623954\",\"password\": \"cxl111111\",\"device\": \"pc\",\"platform\": \"sugo\",\"clientIP\": \"10.255.1.112\"}";
//        RequestDTO requestDTO = new RequestDTO();
//        requestDTO.setUrl("user_account.svc/api/accounts");
//        requestDTO.setBody(json);
//        requestDTO.setMethod("post with row");
